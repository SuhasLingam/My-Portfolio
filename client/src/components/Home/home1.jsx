...
const home1 = () => {
  return (
    <div>
      <div className="p-2 flex-wrap block md:text-5xl lg:text-6xl md:left-[60px] md:top-[250px] text-4xl fixed text-wrap z-10 items-center top-[210px] left-[15px] align-middle lg:top-[330px] lg:left-[150px] text-white">
